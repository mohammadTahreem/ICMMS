...
struct ICMMSApp: App {
    ...
    var body: some Scene {
        ...
        WindowGroup {
            ...
            MainScreen(deviceToken: Messaging.messaging().fcmToken!)
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    @ObservedObject var isFrom: IsFromNotificationClass = IsFromNotificationClass()
...
extension AppDelegate : UNUserNotificationCenterDelegate {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        if state == .background || state == .active || state == .inactive  {
            ...
            if let msgId = userInfo["msgId"] as? String{
                UserDefaults.standard.setValue(msgId, forKey: "msgId")
            }
